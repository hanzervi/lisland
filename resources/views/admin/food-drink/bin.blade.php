...
<div class="content">
    <div class="container-fluid">
        <a href="{{ url('admin/food-and-drink') }}">
...
<script>
    ...
    function callDt() {
        $("#tb").DataTable({
            bDestroy: true,
            ajax: {
                url: "{{ url('/admin/food-and-drink/bin/table') }}",
                dataSrc: ""
            },
            columns: [
                {
            ...
            buttons: {
                ...
                Yes: {
                    ...
                    action: function(){
                        ...
                        $.ajax({
                            url: "{{ url('/admin/food-and-drink/bin/restore') }}/"+id,
                            method: 'post',
                            processData:false,
                            contentType: false,
            ...
            buttons: {
                ...
                Yes: {
                    ...
                    action: function(){
                        ...
                        $.ajax({
                            url: "{{ url('/admin/food-and-drink/bin/removeP') }}/"+id,
                            method: 'post',
                            processData:false,
                            contentType: false,
                            success: function(result){
